...
public class ListenerIdentityEdgeRemoveIdentity extends ExtensionListener {
     ...
     */
    ListenerIdentityEdgeRemoveIdentity(final ExtensionApi extensionApi, final String type, final String source) {
    ...
    public void hear(final Event event) {
        if (event == null || event.getEventData() == null) {
            MobileCore.log(LoggingMode.DEBUG, IdentityEdgeConstants.LOG_TAG, "Event or Event data is null. Ignoring the event listened by ListenerIdentityEdgeRemoveIdentity");
            return;
        }
        ...
        if (parentExtension == null) {
            MobileCore.log(LoggingMode.DEBUG, IdentityEdgeConstants.LOG_TAG,
                    "The parent extension, associated with the ListenerIdentityEdgeRemoveIdentity is null, ignoring event.");
            return;
        }
