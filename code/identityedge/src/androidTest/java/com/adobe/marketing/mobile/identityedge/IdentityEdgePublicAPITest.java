...
public class IdentityEdgePublicAPITest {
    ...
    public void testGetExtensionVersionAPI() {
        assertEquals(IdentityEdgeConstants.EXTENSION_VERSION, IdentityEdge.extensionVersion());
    }
    ...
    public void testRegisterExtensionAPI() throws InterruptedException {
        ...
        Map<String, String> sharedStateMap = flattenMap(getSharedStateFor(IdentityEdgeTestConstants.SharedStateName.EVENT_HUB, 1000));
        assertEquals(IdentityEdgeConstants.EXTENSION_VERSION, sharedStateMap.get("extensions.com.adobe.identityedge.version"));
    }
}
