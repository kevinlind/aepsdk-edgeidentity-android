...
/**
* Verifies that primary ECID is not null for the Edge Identity extension. This method checks for
* the data in shared state, persistence and through getExperienceCloudId API.
*/
...
/**
* Verifies that primary ECID for the Edge Identity Extension is equal to the value provided. This
* method checks for the data in shared state, persistence and through getExperienceCloudId API.
*/
