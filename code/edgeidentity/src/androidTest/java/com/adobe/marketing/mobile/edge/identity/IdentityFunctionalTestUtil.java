...
public class IdentityFunctionalTestUtil {
	...
	/**
	* Verifies that primary ECID is not null for the Edge Identity extension. This method checks
	* for the data in shared state, persistence and through getExperienceCloudId API.
	*/
	...
	* This method checks for the data in shared state, persistence and through getExperienceCloudId
	* API.
	*/
