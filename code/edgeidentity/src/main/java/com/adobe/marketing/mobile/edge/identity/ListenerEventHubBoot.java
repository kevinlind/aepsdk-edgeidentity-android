...
/**
* Method that gets called when event with event type {@link IdentityConstants.EventType#HUB} and
* with event source {@link IdentityConstants.EventSource#BOOTED} is dispatched through eventHub.
*
