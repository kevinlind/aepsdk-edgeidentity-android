...
public class IdentityMap {
    ...
    /**
     * Use this method to cast the {@link IdentityMap} as {@code Map<String, Object>} to be passed
     * as EventData for an SDK Event. This method returns an empty map if the {@code IdentityMap}
     * contains no data
     *
    ...
    /**
     * Use this method to cast the {@link IdentityMap} as {@code Map<String,Object>} to be passed as
