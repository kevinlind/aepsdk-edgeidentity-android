...
* @param item {@link IdentityItem} to be added to the namespace
* @param namespace the namespace integration code or namespace ID of the identity
* @param isFirstItem on {@code true} keeps the provided {@code IdentityItem} as the first element
*     of the identity list for this namespace
* @see <a
*     href="https://github.com/adobe/xdm/blob/master/docs/reference/context/identityitem.schema.md">IdentityItem
*     Schema</a>
*/
...
*
* @param allowEmpty If false and if this {@code IdentityMap} contains no data, then returns a map
*     with empty xdmFormatted Identity Map. If true and if this {@code IdentityMap} contains no
*     data, then returns an empty map
* @return {@code Map} representation of xdm formatted IdentityMap
*/
