...
// TODO: add tests / replace with third party library for json conversion; test more around
// jsonObject/jsonArray with null nodes
// TODO: check what should be the expected behavior with the konductor team (e.g. don't add the
// null nodes or add them with null values)
/**
* Converts provided {@link JSONObject} into {@link Map} for any number of levels, which can be
...
* @return {@link Map} containing the elements from the provided json, null if {@code jsonObject}
*     is null
*/
