...
class Utils {
     ...
     * @return {@link Map} containing the elements from the provided json, null if {@code
     *     jsonObject} is null
     */
     ...
     * @return {@link List} containing the elements from the provided json, null if {@code
     *     jsonArray} is null
     */
