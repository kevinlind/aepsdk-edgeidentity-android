...
/**
 * Identity is used to clearly distinguish people that are interacting with digital experiences. An
 * {@code IdentityItem} is intended to be included in an instance of {@link IdentityMap}.
 *
 * @see <a
 *     href="https://github.com/adobe/xdm/blob/master/docs/reference/datatypes/identityitem.schema.md">Identity
 *     Item Schema</a>
 */
public final class IdentityItem {
    ...
    /**
     * Creates a new {@link IdentityItem} with default values {@code authenticatedState) is set to
     * AMBIGUOUS (@code primary} is set to false
     *
    ...
    /**
     * Indicates if this identity is the preferred identity. Is used as a hint to help systems
     * better organize how identities are queried.
     *
