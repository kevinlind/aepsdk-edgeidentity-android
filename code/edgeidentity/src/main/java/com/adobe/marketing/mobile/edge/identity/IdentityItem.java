...
/**
* Creates a new {@link IdentityItem} with default values authenticatedState is set to AMBIGUOUS
...
Map<String, Object> toObjectMap() {
	...
	map.put(
		IdentityConstants.XDMKeys.AUTHENTICATED_STATE, AuthenticatedState.AMBIGUOUS.getName());
	}
...
static IdentityItem fromData(final Map<String, Object> data) {
	...
	MobileCore.log(
		LoggingMode.DEBUG, LOG_TAG, "IdentityItem - Failed to create IdentityItem from data.");
	return null;
	}
}
}
