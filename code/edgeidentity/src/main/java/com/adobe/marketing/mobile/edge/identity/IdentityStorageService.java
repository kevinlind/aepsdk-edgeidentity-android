...
static IdentityProperties loadPropertiesFromPersistence() {
	final SharedPreferences sharedPreferences =
		getSharedPreference(IdentityConstants.DataStoreKey.DATASTORE_NAME);
	...
	final String jsonString =
		sharedPreferences.getString(IdentityConstants.DataStoreKey.IDENTITY_PROPERTIES, null);
...
*
* @return {@link ECID} stored in direct Identity extension's persistence, or null if no ECID
*     value is stored.
*/
static ECID loadEcidFromDirectIdentityPersistence() {
	final SharedPreferences sharedPreferences =
		getSharedPreference(IdentityConstants.DataStoreKey.IDENTITY_DIRECT_DATASTORE_NAME);
	...
	final String ecidString =
		sharedPreferences.getString(IdentityConstants.DataStoreKey.IDENTITY_DIRECT_ECID_KEY, null);
...
*
* <p>Returns null if the app or app context is not available
*
