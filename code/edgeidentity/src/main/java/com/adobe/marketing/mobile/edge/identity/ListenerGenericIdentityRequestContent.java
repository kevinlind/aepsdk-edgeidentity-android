...
class ListenerGenericIdentityRequestContent extends ExtensionListener {
     ...
     */
    ListenerGenericIdentityRequestContent(
     ...
     * IdentityConstants.EventType#GENERIC_IDENTITY} and with event source {@link
     * IdentityConstants.EventSource#REQUEST_CONTENT} is dispatched through eventHub.
     *
     * @param event the generic identity request content {@link Event} to be processed
     */
    @Override
    public void hear(final Event event) {
        if (event == null || event.getEventData() == null) {
            MobileCore.log(
                    ...
                    "ListenerGenericIdentityRequestContent - Event or Event data is null. Ignoring the event.");
            return;
        }
