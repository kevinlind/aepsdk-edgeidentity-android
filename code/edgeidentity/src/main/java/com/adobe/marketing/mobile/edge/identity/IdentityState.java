...
class IdentityState {
     ...
     * (ideally meaning first launch), then we attempt to read ECID for the direct Identity
     * Extension. If there is no ECID loaded from the persistence of direct Identity Extension, then
     * and new ECID is generated and persisted finishing the bootUp sequence.
     */
    void bootUp() {
