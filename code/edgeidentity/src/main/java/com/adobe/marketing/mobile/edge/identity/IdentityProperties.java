...
class IdentityProperties {
     ...
     * IdentityMap} will be added to the current identifiers Certain namespaces are not allowed to
     * be modified and if exist in the given customer identifiers will be removed before the update
     ...
     *
     * @param allowEmpty If this {@link IdentityProperties} contains no data, return a dictionary
     *     with a single {@link IdentityMap} key
