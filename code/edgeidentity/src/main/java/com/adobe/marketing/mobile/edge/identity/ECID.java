...
ECID() {
	...
	ecidString =
		String.format(Locale.US, "%019d%019d", most < 0 ? -most : most, least < 0 ? -least : least);
}

/**
* Creates a new ECID with the passed in string
*
* @param ecidString a valid (38-digit UUID) ECID string representation, if null or empty a new
*     ECID will be generated
*/
