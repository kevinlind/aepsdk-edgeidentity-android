...
public class Identity {
    ...
    /**
     * Updates the currently known {@link IdentityMap} within the SDK. The Identity extension will
     * merge the received identifiers with the previously saved one in an additive manner, no
     * identifiers will be removed using this API. Identifiers which have an empty {@code id} or
     * empty {@code namespace} are not allowed and are ignored.
     *
    ...
    /**
     * Removes the identity from the stored client-side {@link IdentityMap}. The Identity extension
     * will stop sending this identifier. This does not clear the identifier from the User Profile
     * Graph.
     *
