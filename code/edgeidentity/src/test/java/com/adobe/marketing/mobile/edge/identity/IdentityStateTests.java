...
public class IdentityStateTests {
        ...
        mockSharedStateCallback =
                new SharedStateCallback() {
                    ...
                    public Map<String, Object> getSharedState(
                        ...
                        } else if (IdentityConstants.SharedState.IdentityDirect.NAME.equals(
                                stateOwner)) {
    ...
    @Test
    public void
            testBootupIfReady_whenIdentityDirectRegistered_onFirstBoot_waitsForIdentityDirectECID() {
        // setup
        Mockito.when(
                        mockContext.getSharedPreferences(
                                IdentityConstants.DataStoreKey.IDENTITY_DIRECT_DATASTORE_NAME, 0))
    ...
    @Test
    public void
            testBootupIfReady_whenIdentityDirectRegistered_onFirstBoot_usesIdentityDirectECID() {
        // setup
        Mockito.when(
                        mockContext.getSharedPreferences(
                                IdentityConstants.DataStoreKey.IDENTITY_DIRECT_DATASTORE_NAME, 0))
        ...
        assertEquals(
                "1234",
                state.getIdentityProperties().getECID().toString()); // ECID from Identity direct
    ...
    @Test
    public void
            testBootupIfReady_whenIdentityDirectRegistered_onFirstBoot_whenIdentityDirectECIDNull_generatesNew() {
        // setup
        Mockito.when(
                        mockContext.getSharedPreferences(
                                IdentityConstants.DataStoreKey.IDENTITY_DIRECT_DATASTORE_NAME, 0))
    ...
    public void testUpdateCustomerIdentifiers_happy() throws Exception {
        ...
        Map<String, Object> identityXDM =
                createXDMIdentityMap(new IdentityTestUtil.TestItem("UserId", "secretID"));
        ...
        Map<String, String> persistedData =
                flattenJSONString(persistenceValueCaptor.getAllValues().get(0));
    ...
    @Test
    public void testUpdateCustomerIdentifiers_whenCaseSensitiveNamespace_storesAll()
            throws Exception {
        // setup
        IdentityProperties properties = new IdentityProperties();
        properties.setECID(new ECID("internalECID"));
